...
public class NutSql2 extends NutStatement implements Sql {
    ...
    public NutSql2(String source) {
        this(source, null);
    }

    public NutSql2(String source, SqlCallback callback) {
    ...
    public Sql duplicate() {
        return new NutSql2(sourceSql, callback);
    }
