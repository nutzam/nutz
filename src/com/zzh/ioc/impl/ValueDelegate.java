...
public abstract class ValueDelegate {
	...
	static <T> ValueDelegate eval(Ioc ioc, String objectName, Class<?> valueType, Val val) {
	...
	private static class ThrowableInnerValueDelegate extends ValueDelegate {
		...
		@SuppressWarnings("unchecked")
		<T> ThrowableInnerValueDelegate(Ioc ioc, Class<?> type, Obj obj) {
	...
	private static class SingletonInnerValueDelegate extends ValueDelegate {
		...
		@SuppressWarnings("unchecked")
		SingletonInnerValueDelegate(Ioc ioc, Class<?> type, Obj obj) {
	...
	private static class MapValueDelegate extends ValueDelegate {
		...
		<T> MapValueDelegate(Ioc ioc, String objectName, Map<String, Object> map) {
	...
	private static class ArrayValueDelegate extends ValueDelegate {
		...
		<T> ArrayValueDelegate(Ioc ioc, String objectName, Class<?> elementType, Object[] array) {
