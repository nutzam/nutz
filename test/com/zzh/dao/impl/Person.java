...
public class Person {
	...
	public static void prepareTable(Dao dao) {
		String[] keys = { ".drop", ".create"};
		Main.prepareTables(dao,keys);
		dao.insert(new Person("zyy", "zyy@unknown.com", 0, 0, null));
		dao.insert(new Person("yy", "yy@unknown.com", 1, 0, null));
		dao.insert(new Person("ycs", "sm@163.com", 2, 0, null));
		dao.insert(new Person("zzh", "zozohtnn@gmail.com", 3, 0, null));
		dao.insert(new Person("ydl", "youoo@129.com", 3, 0, null));
		dao.insert(new Person("Merry", "merry@zozoh.com", 0, 4, "zzh"));
		dao.insert(new Person("John", "john@zozoh.com", 0, 4, "zzh"));
	}
