...
import org.nutz.json.Person;
import org.nutz.json.Room;
...
public class Json2Test {
	...
	public void test_unknown_field_in_json_string() {
		Abc abc = Json2.fromJson(Abc.class, "{id:2,name:'zzh',uuab:'ttt'}");
	...
	public void field_name_with_colon() {
		Map<?, ?> map = (Map<?, ?>) Json2.fromJson("{'i\"d:':6};");
		assertEquals(6, map.get("i\"d:"));
	}

	@Test
	public void with_var_ioc_as_prefix() {
		Map<?, ?> map = (Map<?, ?>) Json2.fromJson("var ioc = {id:6};");
		assertEquals(6, map.get("id"));

		map = (Map<?, ?>) Json2.fromJson("\t\n\r   var ioc= {id:6};");
		assertEquals(6, map.get("id"));
	}

	@Test
	public void born_with_map() {
		Map<?, ?> map = Json2.fromJson(Map.class, "{a:'A'}");
	...
	public void when_name_has_unsupport_char() {
		...
		map.put("/tt", 123);
		assertEquals("{\"/tt\":123}", Json2.toJson(map, JsonFormat.compact().setQuoteName(false)));
	}
	...
	public void when_name_has_number_char_at_first() {
		Map<String, Integer> map = new HashMap<String, Integer>();
		map.put("3T", 123);
		assertEquals("{\"3T\":123}", Json2.toJson(map, JsonFormat.compact().setQuoteName(false)));
	}

	@Test
	public void testSimpleObject() {
		assertEquals("6.5", Json2.toJson(6.5));
		assertEquals("\"json\"", Json2.toJson("json"));
		int[] ints = new int[0];
		assertEquals("[]", Json2.toJson(ints));
		ints = new int[1];
		ints[0] = 65;
		assertEquals("[65]", Json2.toJson(ints));
		assertEquals(65, Json2.fromJson(Lang.inr("65")));
		assertEquals(Float.valueOf("65"), Json2.fromJson(float.class, Lang.inr("65")));
		assertEquals(ints[0], Json2.fromJson(int[].class, Lang.inr("[65]"))[0]);
	}

	@Test
	public void testBoolean() {
		assertTrue(Json2.fromJson(boolean.class, Lang.inr("true")));
		try {
			Json2.fromJson(boolean.class, Lang.inr("ture"));
			fail();
		}
		catch (JsonException e) {}
		assertFalse(Json2.fromJson(boolean.class, Lang.inr("false")));
		assertTrue(((Boolean) Json2.fromJson(Lang.inr("true"))).booleanValue());
		assertFalse(((Boolean) Json2.fromJson(Lang.inr("false"))).booleanValue());
	}

	@Test
	public void testFloat() {
		assertEquals(Float.valueOf(2.3f), Json2.fromJson(float.class, Lang.inr("2.3")));
		assertEquals((Float) 2.3f, Json2.fromJson(Float.class, Lang.inr("2.3")));
		assertEquals(Float.valueOf(.3f), Json2.fromJson(float.class, Lang.inr(".3")));
	}

	@Test
	public void testLongg() {
		assertEquals(87L, Json2.fromJson(long.class, Lang.inr("87")).longValue());
		assertEquals(87L, ((Long) Json2.fromJson(Lang.inr("87L"))).longValue());
	}

	@Test
	public void testDatetime() {
		java.util.Date date = Json2.fromJson(java.util.Date.class,
	...
	public void testSimpleAbc() {
		...
		Abc abc = Json2.fromJson(Abc.class, Lang.inr(s));
	...
	public void testAllTypesInMap() throws FileNotFoundException {
		Map<String, Object> map = (Map<String, Object>) Json2.fromJson(new InputStreamReader(getClass().getResourceAsStream("/org/nutz/json/types.txt")));
	...
	public void testSimpleString() {
		String s = (String) Json2.fromJson(Lang.inr(""));
		assertEquals(null, s);

		s = (String) Json2.fromJson(Lang.inr("\"\""));
		assertEquals("", s);
	}
	...
	public void testSimpleMap() {
		...
		Map<?, ?> map = (Map<?, ?>) Json2.fromJson(Lang.inr(s));
	...
	public void testMap() throws FileNotFoundException {
		Map<String, Object> map = Json2.fromJson(HashMap.class,
	...
	public void testSimplePersonObject() throws Exception {
		Person p = Json2.fromJson(	Person.class,
	...
	public void testSimpleArraySingleInteger() throws Exception {
		String s = "[2]";
		int[] ary = Json2.fromJson(int[].class, Lang.inr(s));
	...
	public void testSimpleArraySingleDate() throws Exception {
		String s = "[\"2008-8-1\"]";
		java.sql.Date[] ary = Json2.fromJson(java.sql.Date[].class, Lang.inr(s));
		assertEquals(1, ary.length);
		Calendar cal = Calendar.getInstance();
		cal.setTime(ary[0]);
		assertEquals(2008, cal.get(Calendar.YEAR));
	...
	public void testSimpleArraySingleObject() throws Exception {
		...
		Abc[] ary = Json2.fromJson(Abc[].class, Lang.inr(s));
		assertEquals(1, ary.length);
	...
	public void testNiceModeSimple() throws Exception {
		...
		s = "{id:45,name:'\"X\"'}";
		abc = Json2.fromJson(Abc.class, Lang.inr(s));
		assertEquals(45, abc.id);
	...
	public void testPrintJsonObject() throws Exception {
		Person p = Json2.fromJson(	Person.class,
									getFileAsInputStreamReader("org/nutz/json/person.txt"));
		String json = Json2.toJson(p, JsonFormat.nice());
		Person p2 = Json2.fromJson(Person.class, Lang.inr(json));
	...
	public void testFilterField() throws Exception {
		Person p = Json2.fromJson(	Person.class,
									getFileAsInputStreamReader("org/nutz/json/person.txt"));
		String json = Json2.toJson(p, JsonFormat.nice().setActived("^name$"));
		Person p2 = Json2.fromJson(Person.class, Lang.inr(json));
		assertEquals(p.getName(), p2.getName());
	...
	public void testFilterField2() throws Exception {
		Person p = Json2.fromJson(	Person.class,
									getFileAsInputStreamReader("org/nutz/json/person.txt"));
		String json = Json2.toJson(p, JsonFormat.nice().setLocked("realname|father|company"));
		Person p2 = Json2.fromJson(Person.class, Lang.inr(json));
		assertNull(p2.getRealname());
		assertEquals(p.getName(), p2.getName());
		assertEquals(p.getAge(), p2.getAge());
	...
	public void testOutpuProjectsAsList() throws Exception {
		...
		Project p2 = Json2.fromJson(Project.class, Json2.toJson(p));
	...
	public void testUndefined() throws Exception {
		...
		Project p = Json2.fromJson(Project.class, Lang.inr(exp));
	...
	public void testEnumOutput() throws Exception {
		...
		x.id = 5;
		x.type = XT.B;
		X x2 = Json2.fromJson(X.class, Json2.toJson(x));
	...
	public void testEmptyMap() throws Exception {
		Map<?, ?> map = (Map<?, ?>) Json2.fromJson(Lang.inr("{}"));
		assertEquals(0, map.size());
		map = (Map<?, ?>) Json2.fromJson(Lang.inr("  {/*rrrrrrrr*/   }"));
		assertEquals(0, map.size());
	}

	@Test
	public void testEmptyObject() throws Exception {
		X x = Json2.fromJson(X.class, Lang.inr("{}"));
		assertEquals(0, x.id);
		assertNull(x.type);
	}
	...
	public void test_output_not_quote_name() {
		...
		String json = Json2.toJson(b, JsonFormat.compact().setQuoteName(false));
		Base b2 = Json2.fromJson(Base.class, json);
	...
	public void testDuplicateArrayList() {
		...
		a.list2.add("aaa");
		String json = Json2.toJson(a, JsonFormat.compact().setQuoteName(false));
	...
	public void test_special_char() {
		String s = "\\|\n|\r|\t";
		String exp = "\"\\\\|\\n|\\r|\\t\"";
		assertEquals(exp, Json2.toJson(s));
		assertEquals(s, Json2.fromJson(exp));
	}
	...
	public void test_number_output() {
		...
		map.put("a", "123");
		String re = Json2.toJson(map, JsonFormat.compact().setQuoteName(false));
		assertEquals("{a:\"123\"}", re);
	}

	@Test
	public void test_dollar_as_name() {
		Map<String, Object> map = (Map<String, Object>) Json2.fromJson("{$a:-23,b:-2.7}");
	...
	public void test_ioc_value() {
		...
		IocValue iv = Json2.fromJson(IocValue.class, s);
	...
	public void test_field_as_map_with_list_value() {
		...
		TFAMWLV obj = Json2.fromJson(TFAMWLV.class, str);
	...
	public void test_output_nostr_key_map() {
		...
		map.put(22, "hello");
		assertEquals("{\"22\":\"hello\"}", Json2.toJson(map, JsonFormat.compact()));
	}

	@Test
	public void test_separator() {
		String str = "Nutz";
		assertEquals("\"Nutz\"", Json2.toJson(str, JsonFormat.compact().setSeparator('\"')));
		assertEquals("'Nutz'", Json2.toJson(str, JsonFormat.compact().setSeparator('\'')));
	}

	@Test
	public void test_setvalue_by_setter() {
		Person p = Json2.fromJson(Person.class, "{num:1}");
	...
	public void test_toJson() {
		...
		assertEquals("ItMe", Json2.toJson(pc));
	}
	...
	public void test_X(){
		...
		assertEquals("{\"abc\":\"abc\\u4E2D\\u6587abc\"}",Json2.toJson(map,format));
	}
	
	@Test
	public void test_toList(){
		List<Map<String,Integer>> msgList = Json2.fromJson(List.class, "[{'a':1}, {'b':2}]");
