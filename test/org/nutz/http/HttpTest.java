...
public class HttpTest {
    ...
    // data.put("value", 31.3);
    // String url =
    // String.format("http://api.yeelink.net/v1.1/device/%s/sensor/%s/datapoints",
    // device_id, sensor_id);
    ...
    //
    // @Test
    // public void test_12306() throws NoSuchAlgorithmException,
    // KeyManagementException {
    // String url =
    // "https://kyfw.12306.cn/otn/leftTicket/queryT?leftTicketDTO.train_date=2015-01-12&leftTicketDTO.from_station=UXP&leftTicketDTO.to_station=SJP&purpose_codes=ADULT";
    // try {
    ...
    // assertEquals(expected, cookie.toString()); // 所以两次toString的结果是一样的,
    // 即同一个session
    // }
